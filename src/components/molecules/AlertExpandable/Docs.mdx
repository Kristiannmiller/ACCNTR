...
import * as AlertExpandableStories from './AlertExpandable.stories';

<Meta title="Design System/molecules/AlertExpandable/Docs" of={ AlertExpandableStories} />
...
## Description
The AlertExpandable component is a type of alert that implements an Accordion to display additional content. 
