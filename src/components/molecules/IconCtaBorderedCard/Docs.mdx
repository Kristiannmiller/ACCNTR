...
import * as IconCtaBorderedCardStories from './IconCtaBorderedCard.stories';

<Meta title="Design System/molecules/IconCtaBorderedCard/Docs" of={ IconCtaBorderedCardStories} />

# IconCtaBorderedCard

Story Link: [#168](https://github.com/ahc-digital/migration-planning-tracking/issues/168)

Description: The Icon CTA Bordered Card component is being used in the Icon CTA Bordered component.
