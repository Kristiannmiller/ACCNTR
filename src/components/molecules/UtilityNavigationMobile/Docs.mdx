...
import * as UtilityNavigationMobileStories from './UtilityNavigationMobile.stories';

<Meta title="Design System/molecules/UtilityNavigationMobile/Docs" of={ UtilityNavigationMobileStories} />
