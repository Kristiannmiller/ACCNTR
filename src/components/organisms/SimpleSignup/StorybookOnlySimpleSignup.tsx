...
export type StorybookOnlySimpleSignupProps = ComponentProps<
    typeof Container
> & {
...
export const StorybookOnlySimpleSignup = (
    props: StorybookOnlySimpleSignupProps
) => {
    const {
        alignment = 'center',
            ...
            <div>
                <div
                    ...
                    <StorybookOnlyForm
                        ...
                        className={cx(styles['simple-signup-form'], {
                            [styles['center']]: alignment === 'center'
                        })}
                        backgroundColor={backgroundColor}
                        formName={<JSSText field={{ value: 'simpleSignUp' }} />}
                        formioDomain='https://forms2-prod.ahcdigital.org/aah'
                        thankYouPageUrl={
                            <JSSLink
                                field={{ href: 'https://i.pm0.net/subscribe' }}
                            />
                        }
                    />
