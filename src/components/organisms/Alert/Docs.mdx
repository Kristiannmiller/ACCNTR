...
<Meta title="Design System/organisms/Alert/Docs" of={ AlertStories} />
...
## Description
The alerts are banners that sit above the utility navigation when present. They come in 5 different themes and may optionally be dismissible (configured by content authors).
