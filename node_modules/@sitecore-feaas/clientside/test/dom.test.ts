...
describe('DOM Clientside', function () {
  ...
  describe('render with data', function () {
    ...
    it('should not render null mapped attribute', function () {
      assertRenderedHTML(
        `<div><img data-path-src="image" /></div>`,
        { image: null },
        '<div><img data-path-src="image" /></div>'
    ...
    it('should fall back to trimmed array path', function () {
      assertRenderedHTML(
        `<div><img data-path-src="context.test.$[1:2].image" /></div>`,
        { context: [{ image: 'a.jpg' }, { image: 'b.jpg' }] },
        '<div><img data-path-src="context.test.$[1:2].image" src="b.jpg" /></div>'
      )
    })
    it('should fall back to global path when using trimmed array', function () {
      assertRenderedHTML(
        `<div><img data-path-src="context.test.$[1:2].image" /></div>`,
    ...
    it('should fall back to catch all path when using trimmed array', function () {
      assertRenderedHTML(
        `<div><img data-path-src="context.test.$[1:2].image" /></div>`,
        { _: [{ image: 'a.jpg' }, { image: 'b.jpg' }] },
        '<div><img data-path-src="context.test.$[1:2].image" src="b.jpg" /></div>'
      )
    })
    ...
    /*
    it('should render attributes object with global top level fallback', function () {
      assertRenderedHTML(
        `<div data-path-attributes="test"></div>`,
        { a: 'a.jpg', b: 2, c: { user: 'yarik' } },
        '<div data-path-attributes="test" a="a.jpg" b="2" c="{&quot;user&quot;:&quot;yarik&quot;}" data-attributes-keys="a,b,c"></div>'
      )
    }) */
    it('should render attributes in dynamic html', function () {
      ...
      assertRenderedHTML(
        `<var data-path="html"></var>`,
        { html: '<img data-path-src="image" />', image: '1.jpg' },
        '<var data-path="html"><img data-path-src="image" src="1.jpg" /></var>'
      )
      assertRenderedHTML(
        `<p><var data-path="html"></var></p>`,
        { html: '<img data-path-src="image" />', image: '1.jpg' },
        '<p><var data-path="html"><img data-path-src="image" src="1.jpg" /></var></p>'
      )
      assertRenderedHTML(
        `<p><var data-path="html">test</var></p>`,
        { html: '<p>test</p>' },
        '<p><var data-path="html">test</var></p>'
      )
      assertRenderedHTML(
        `<h1><var data-path="html">test</var></h1>`,
        { html: '<p>test</p><p>test2</p>' },
        '<h1><var data-path="html">test test2</var></h1>'
      )
      assertRenderedHTML(
        `<h1><var data-path="html">test</var></h1>`,
        { html: '<p>test</p><p>test2</p>' },
      ...
      assertRenderedHTML(
        `<div><var data-path="html">test</var></div>`,
        { html: '<h1>test</h1>' },
        '<div><var data-path="html"><h1>test</h1></var></div>'
      )
      assertRenderedHTML(
        `<div data-path="html">test</div>`,
        { html: '<h1>test</h1>' },
        '<div data-path="html"><h1>test</h1></div>'
      )
      assertRenderedHTML(
        `<li><var data-path="html">test</var></li>`,
        { html: '<p>test</p>' },
        '<li><var data-path="html">test</var></li>'
      )
      assertRenderedHTML(
  ...
  describe('render multiplied with nested arrays and with parent context', () => {
    ...
    describe('render with data and placeholders', () => {
      it('should fall back the variable text', () => {
        assertRenderedHTML(
          `<div><h1><var data-path="existing" data-path-placeholder="Placeholder"></var></h1></div>`,
          { existing: 'Existing' },
          `<div>
                <h1>
                    <var data-path="existing" data-path-placeholder="Placeholder">Existing</var>
                </h1>
            </div>`
        )
        assertRenderedHTML(
          `<div><h1><var data-path="missing" data-path-placeholder="Placeholder"></var></h1></div>`,
          { existing: 'Existing' },
          `<div>
                <h1>
                    <var data-path="missing" data-path-placeholder="Placeholder">Placeholder</var>
                </h1>
            </div>`
        )
      })
      it('should fall back the img src', () => {
        assertRenderedHTML(
          `<div><img data-path-src="existing" data-path-placeholder="Placeholder" /></div>`,
          { existing: 'Existing' },
          `<div>
            <img data-path-src="existing" data-path-placeholder="Placeholder" src="Existing" />
            </div>`
        )
        assertRenderedHTML(
          `<div><img data-path-src="missing" data-path-placeholder="Placeholder" /></div>`,
          { existing: 'Existing' },
          `<div>
            <img data-path-src="missing" data-path-placeholder="Placeholder" src="Placeholder" />
            </div>`
        )
      })
      it('should fall back the media block src', () => {
        assertRenderedHTML(
          `<div><div class="-block--media" data-path-src="existing" data-path-placeholder="Placeholder"><img src="" /></div></div>`,
          { existing: 'Existing' },
          `<div>
            <div class="-block--media" data-path-src="existing" data-path-placeholder="Placeholder"><img src="Existing" /></div>
          </div>`
        )
        assertRenderedHTML(
          `<div><div class="-block--media" data-path-src="missing" data-path-placeholder="Placeholder"><img src="" /></div></div>`,
          { existing: 'Existing' },
          `<div>
            <div class="-block--media" data-path-src="missing" data-path-placeholder="Placeholder"><img src="Placeholder" /></div>
          </div>`
        )
      })
      it('should fall back the regular blocks', () => {
        assertRenderedHTML(
          `<div><div class="-block--card" data-path-src="existing" data-path-placeholder="Placeholder"><picture><img src="" /></div></picture></div>`,
          { existing: 'Existing' },
          `<div>
            <div class="-block--card" data-path-src="existing" data-path-placeholder="Placeholder"><picture><img src="Existing" /></picture></div>
          </div>`
        )
        assertRenderedHTML(
          `<div><div class="-block--card" data-path-src="missing" data-path-placeholder="Placeholder"><picture><img src="" /></picture></div></div>`,
          { existing: 'Existing' },
          `<div>
            <div class="-block--card" data-path-src="missing" data-path-placeholder="Placeholder"><picture><img src="Placeholder" /></picture></div>
          </div>`
        )
      })
    })
