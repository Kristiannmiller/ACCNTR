...
export function getFramePosition(element) {
    let positions = [];
    if (element) {
...
export function FEAASEditorProps(element) {
    var _a;
    return {
        context: HTMLElement,
        frontend: element === null || element === void 0 ? void 0 : element.getContextAttribute('frontend'),
        src: (_a = element === null || element === void 0 ? void 0 : element.getAttribute('src')) !== null && _a !== void 0 ? _a : '/editor.js',
        library: element === null || element === void 0 ? void 0 : element.getAttribute('library'),
        component: element === null || element === void 0 ? void 0 : element.getAttribute('component'),
        version: element === null || element === void 0 ? void 0 : element.getAttribute('version'),
        instance: element === null || element === void 0 ? void 0 : element.getAttribute('instance'),
        forked: element === null || element === void 0 ? void 0 : element.getAttribute('forked'),
        revision: (element === null || element === void 0 ? void 0 : element.getAttribute('revision')) || 'saved',
        hidden: (element === null || element === void 0 ? void 0 : element.getAttribute('hidden')) != null,
        for: element === null || element === void 0 ? void 0 : element.getAttribute('for'),
        state: (element === null || element === void 0 ? void 0 : element.getAttribute('state')) || 'idle',
        changed: (element === null || element === void 0 ? void 0 : element.getAttribute('changed')) != null
    };
}
class FEAASEditor extends FEAASElement {
    constructor() {
        super(...arguments);
        this.framePoint = { top: 0, left: 0 };
        this.wrapperRect = { top: 0, left: 0, width: 0, height: 0 };
        this.bodyRect = { top: 0, left: 0, width: 0, height: 0 };
        this.defaultProps = {
            hidden: false
        };
        this.setTarget = (element, props = {
        ...
        this.onChromeMeasureElement = (element, rect = element.getBoundingClientRect()) => {
        ...
        this.onBeforeMeasure = (refs) => {
            if (refs.memoized.focusable)
                this.framePoint = getFramePosition(refs.memoized.focusable);
            if (this.chrome) {
        ...
        this.onMeasure = () => { };
        this.onPosition = ({ focusable, root }) => {
            if (!this.chrome || this.props.hidden)
                return;
            if (focusable) {
        ...
        this.onClose = () => {
            ...
            if ((_a = this.target) === null || _a === void 0 ? void 0 : _a.parentNode) {
        ...
        this.onVersionStateChange = (versionContext, setVersionContext) => {
            this.versionContext = versionContext;
            this.setVersionContext = setVersionContext;
        };
        this.onEditorStateChange = (editorContext, setEditorContext) => {
    ...
    showLoader() {
        if (!this.loader) {
            this.loader = document.createElement('feaas-loader');
    ...
    cleanup() {
        var _a;
        if (this.placeholder) {
            (_a = this.placeholder.clipper) === null || _a === void 0 ? void 0 : _a.remove();
    ...
    setVersionContext(props) {
        console.log('Editor is not ready');
    }
    setEditorContext(props) {
        console.log('Editor is not ready');
    }
    setLoadingState() {
        this.showLoader();
    ...
    render({ children, component: componentId, version: versionId, instance: instanceId }, { Editor, VersionStatusList, VersionStatusButton, Version, VersionMenu, EditorUIUndo, EditorUIMode, React: { useEffect, useMemo, useState, useContext }, Chakra: { HStack, Box, Button, MenuItem }, Chrome, ReactDOM, useSDK, useLibrary, useSlots, useModelObserver, ConfirmationContext, VersionContext }) {
        if (!this.payload)
            return;
        ...
        const versions = useModelObserver(component === null || component === void 0 ? void 0 : component.versions, []).filter((v) => v.id == usedId);
        const version = versions[0];
        if (version && !this.props.hidden)
                ...
                setConfirm({
                    ...
                    action: () => {
                        ...
                        (_b = (_a = component
                            ...
                            model: ''
                        })) === null || _a === void 0 ? void 0 : _a.stage()) === null || _b === void 0 ? void 0 : _b.publish();
                        this.removeAttribute('changed');
        ...
        return useMemo(() => component &&
            useSlots(children, ({ picker, children }) => (React.createElement(Box, { ref: (el) => {
                    this.chrome = el
                        ? {
                            positionable: el,
                ...
                React.createElement(Box, { className: 'editor-wrapper', position: 'absolute', left: 0, top: 0 },
                    React.createElement(Editor, { datasources: sdk.datasources, sdk: sdk, library: library, component: component, versions: versions, context: {
                        ...
                        after: children,
                        chrome: ({ editor }) => editor && React.createElement(Chrome, null),
                        children: ({ isArchivedDisplayed, editor, status }) => (React.createElement(Box, { position: 'absolute', left: 0, top: 0, className: 'editor-chrome', p: 4, boxShadow: '2xl', pointerEvents: 'none', opacity: 0, transition: 'opacity 0.3s' },
                            React.createElement(Box, { left: 0, width: '4', top: 0, bottom: 0, backdropFilter: 'blur(2px)', background: 'rgb(244 244 244 / 80%)', position: 'absolute' }),
                            React.createElement(Box, { right: 0, width: '4', top: 0, bottom: 0, backdropFilter: 'blur(2px)', background: 'rgb(244 244 244 / 80%)', position: 'absolute' }),
                            React.createElement(Box, { top: 0, height: '16', left: 0, right: 0, backdropFilter: 'blur(2px)', background: 'rgb(244 244 244 / 80%)', position: 'absolute' }),
                            React.createElement(Box, { bottom: 0, height: '4', left: 0, right: 0, backdropFilter: 'blur(2px)', background: 'rgb(244 244 244 / 80%)', position: 'absolute' }),
                            version && (React.createElement(Version, { version: version, node: target, ignoreBreakpoints: true, deps: [this.props.forked, this.props.changed] }, {
                                exports: this.onVersionStateChange,
                                left: (React.createElement(HStack, { justifyContent: 'space-between' },
                                    React.createElement(EditorUIUndo, { size: 'sm', editor: status == 'ready' ? editor : null }),
                                    React.createElement(EditorUIMode, { size: 'sm' }))),
                                middle: (versionContext, setVersionContext) => [
                                    false && (React.createElement(VersionContext.Provider, { value: [
                                            {
                                                ...versionContext,
                                        ...
                                        React.createElement(VersionStatusList, null)))
                                ],
                                right: (React.createElement(React.Fragment, null,
                                    React.createElement(Button, { variant: 'secondary', size: 'sm', onClick: this.close }, "Close"),
                                    React.createElement(Button, { variant: 'primary', size: 'sm', onClick: this.save, isDisabled: !this.props.changed }, !this.props.changed
                                        ? 'Up to date'
                                        : this.props.forked
                                            ? 'Save'
                                            : 'Save customization'),
                                    React.createElement(VersionMenu, { isDisabled: !this.props.forked && !this.props.changed },
                                        React.createElement(MenuItem, { onClick: this.unfork, isDisabled: !this.props.forked }, "Unfork"),
                                        React.createElement(MenuItem, { onClick: this.discard, isDisabled: !this.props.changed }, "Discard"))))
                            }))))
...
FEAASEditor.observedAttributes = ['library', 'component', 'version', 'revision', 'hidden', 'state', 'changed', 'forked'];
export { FEAASEditor };
FEAASEditor.register('feaas-editor');
//# sourceMappingURL=FEAASEditor.js.map