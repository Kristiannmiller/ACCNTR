 ...
 */
export declare class FEAASElement<Props = any, Payload = any> extends WebComponent {
     ...
     */
    mount(): void;
    dispatchEventIndirectly(event: Event): void;
    isJSONAttribute(attribute: keyof Props): boolean;
    log(...args: any): void;
    /** Nothing special happens on unmount, except setting a flag */
    unmount(): void;
    getParent(onlyFeaas?: boolean): Element;
    ...
    unnestedCallback(target: FEAASElement): void;
    ...
    getReactErrorBoundary(target?: FEAASElement, displayName?: string): (new (...args: any) => React.Component<{
        children: any;
        slot: string;
    }, {
        error: Error;
    ...
    getReactElement(target?: FEAASElement, props?: any): React.JSX.Element;
    getReactWrapper(target?: FEAASElement, displayName?: string): React.FunctionComponent<{}>;
    uid: string;
    getUID(): string;
