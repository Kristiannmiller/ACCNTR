...
export declare function FEAASEditorProps(element: FEAASElement): {
    context: {
        new (): HTMLElement;
...
export declare class FEAASEditor extends FEAASElement<FEAASEditorProps, typeof FEAASEditorImports> {
    ...
    open(): void;
    shouldFork(version: FEAASEditorImports.Model.VersionModel): boolean;
    cleanup(): void;
    onClose: () => void;
    close(): void;
    unfork(): void;
    ...
    render({ children, component: componentId, version: versionId, instance: instanceId }: React.PropsWithChildren<FEAASEditorProps>, { Editor, VersionStatusList, VersionStatusButton, Version, VersionMenu, EditorUIUndo, EditorUIMode, React: { useEffect, useMemo, useState, useContext }, Chakra: { HStack, Box, Button, MenuItem }, Chrome, ReactDOM, useSDK, useLibrary, useSlots, useModelObserver, ConfirmationContext, VersionContext }: typeof FEAASEditorImports): FEAASEditorImports.React.ReactElement<unknown, string | FEAASEditorImports.React.JSXElementConstructor<any>>;
