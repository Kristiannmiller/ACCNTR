...
export declare class RestLayoutService extends LayoutServiceBase {
     ...
     */
    protected getDefaultFetcher: <T>(req?: IncomingMessage | undefined, res?: ServerResponse<IncomingMessage> | undefined) => (url: string, data?: unknown) => Promise<AxiosResponse<T>>;
    /**
